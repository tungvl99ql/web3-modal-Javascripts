...
async function transferUSDT() {
  console.log("Dia chi vi chuyen: ",accounts[0]);
  ...
  let amountUSDTtrasfer = (document.querySelector("#quantity").value * 1000000000000000000).toString(); // so tien chuyen
  ...
  const web3 = new Web3(provider);
  const ContracUSDT = new web3.eth.Contract(USDT_ABI, "0x55d398326f99059ff775485246999027b3197955");
  ...
  ContracUSDT.methods
    .transfer(receiverAddress, amountUSDTtrasfer)
